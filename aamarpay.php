...
function aamarpay_config() {
    $configarray = array(
     "FriendlyName" => array("Type" => "System", "Value"=>"aamarpay"),
...
//echo '</pre>';
	...
	$cancel_url  = $params['systemurl'].'modules/gateways/callback/aamarpay.php';
...
$code .='<input type="hidden" name="amount" value="'.$amount.'" >';
...
$code .= '<input type="hidden" name="cancel_url" value="'.$params['systemurl'].'/modules/gateways/callback/aamarpay.php" />';
...
$code .= '<input type="hidden" name="opt_a" value="'.$basecurrencyamount.'">'; 
$code .= '<input type="hidden" name="opt_b" value="'.$basecurrency.'">';
$code .= '<input type="hidden" name="desc" value="'.$description.'">';	
$code .= '<input type="submit" class="btn btn-success" value="Pay With Credit/Debit Card" />
